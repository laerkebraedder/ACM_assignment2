...
parameters {
  real bias; // Bias is the tendency of the WSLS follow the rule. This parameter is a on a log-odds scale, so – 3 means always doing the opposite of your rule, and +3 means always following the rule.
